...
# === Init ROS node ===
rospy.init_node('horizontal_flight_logger')
...
if __name__ == '__main__':
    try:
        print("🚀 Horizontal flight experiment (Hover + 1–10 m/s sweep)")
        set_flight_mode('GUIDED')
        arm_drone()
        takeoff_drone(20)
        rospy.sleep(15)  # settle after takeoff

        filename = '/home/neha/ardupilot/ArduCopter/horizontal_flight_data_10.csv'
